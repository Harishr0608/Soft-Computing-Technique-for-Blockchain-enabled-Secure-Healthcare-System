					...
					<div class="row">
							...
							<form action="process.jsp">
								<div class="row form-group">
									<div class="col-md-6">
										...
										<input type="text" id="name" class="form-control mb" name="name" placeholder="Your name" required>
									</div>
									<div class="col-md-6">
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<textarea name="text" id="message" cols="30" rows="10" class="form-control" name="address" placeholder="Enter your address" required></textarea>
									</div>
								</div>
						...
						<div class="col-md-6">
							<!--<div id="map" class="colorlib-map"></div>-->
                                                        <iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=cmc%20vellore&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
						</div>
					</div>		
				</div>
			</div>
