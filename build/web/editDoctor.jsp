...
<title>Access Control for Electronic Health Records withHybrid Blockchain-Edge Architecture</title>
<!-- Bootstrap -->
...
<body>
	<div class="container-fluid">
		...
		<div class="row header">
			...
			<div class="col-md-10">
				<h2>
					Access Control for Electronic Health Records withHybrid Blockchain-Edge Architecture
					</h3>
			</div>
