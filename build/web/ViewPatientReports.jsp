...
<body>
	<div class="container-fluid">
		...
		<div class="row header">
			...
			<div class="col-md-10">
				<h2>
					Access Control for Electronic Health Records with
...
<table class="table table-bordered table-hover">
								...
								<%
										...
										ResultSet rs1 = st1.executeQuery("select patientrecords.ID,patient.patient_name as PatientName,nurse.name as NurseName,patientrecords.BMP, patientrecords.CBC, patientrecords.BP, patientrecords.KCL, patientrecords.PMS, patientrecords.HEARTRATE, patientrecords.PULSE,patientrecords.CreatedDate from patientrecords  inner join nurse on nurse.nurse_id = patientrecords.LabID inner join patient on patient.patient_id = patientrecords.PatientID  where patientrecords.PatientID='" + val2 + "' and patientrecords.RequestStatus='" + approved + "' ");
										while (rs1.next()) {
